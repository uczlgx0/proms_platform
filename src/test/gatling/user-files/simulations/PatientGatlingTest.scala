...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "familyName":"SAMPLE_TEXT", "givenName":"SAMPLE_TEXT", "birthDate":"2020-01-01T00:00:00.000Z", "gender":null, "nhsNumber":null, "email":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
